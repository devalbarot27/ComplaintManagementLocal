    ...
    <div class="main-wrapper" id="mainWrapper">
        ...
        <div class="content">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <div>
                    <h5 class="mb-1">Role #<?php echo (int) $record['id']; ?></h5>
                </div>
                <div>
                    <a href="roles.php" class="btn btn-light border">Back to Role List</a>
                </div>
            </div>

            <div class="booking-card">
                <div class="booking-header">
                    <div class="booking-title"><?php echo htmlspecialchars($record['role_name']); ?></div>
                </div>
                <div class="p-3">
                    <div class="row g-3">
                        <div class="col-md-6"><strong>Role Name:</strong><br><?php echo htmlspecialchars($record['role_name']); ?></div>
